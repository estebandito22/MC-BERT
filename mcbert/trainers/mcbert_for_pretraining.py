...
class MCBertForPretraining(Trainer):
    ...
    def __init__(self, vis_feat_dim=2048, spatial_size=7, bert_hidden_dim=768,
        ...
        ----
            ...
            bert_hidden_dim : int, size of hidden state in BERT.
    ...
    def _init_nn(self, train_dataset_len):
        ...
        self.optimizer = BertAdam(
            ...
            t_total=int(train_dataset_len / self.batch_size * self.num_epochs))
    ...
    def fit(self, train_dataset, val_dataset, save_dir):
        ...
        print("Settings:\n\
               ...
               Warmup Proportion: {}\n\
               Save Dir: {}".format(
                   self.vis_feat_dim, self.spatial_size, self.bert_hidden_dim,
